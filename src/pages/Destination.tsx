...
function Destination() {
  ...
  return (
    <div className="flex flex-col items-center min-h-full bg-[url('./assets/destination/background-destination-mobile.jpg')] bg-no-repeat bg-cover text-white pt-[88px] px-[24px] md:bg-[url('./assets/destination/background-destination-tablet.jpg')] md:pt-[136px] md:px-[39px] lg:pt-[212px] lg:px-0 lg:bg-[url('./assets/destination/background-destination-desktop.jpg')]">
      <div className="flex gap-[18px]  font-barlow font-normal text-base/[19px] tracking-[2.7px] uppercase md:text-[20px] md:leading-[24px] md:self-start   lg:pl-[166px] lg:text-[28px] lg:leading[34px] lg:tracking-[4.725px]">
