function Home() {
  return (
    <div className="flex flex-col items-center h-[100%] bg-[url('./assets/home/background-home-mobile.jpg')] bg-no-repeat bg-cover">
      ...
      <button className="w-[150px] h-[150px] text-green-500   bg-[#fff] rounded-[50%] text-center ">
        EXPLORE
      </button>
    </div>
  );
